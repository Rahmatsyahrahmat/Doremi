...
import kotlinx.android.synthetic.main.view_item_album_track.view.trackFavorite
import kotlinx.android.synthetic.main.view_item_album_track.view.trackMore
import kotlinx.android.synthetic.main.view_item_album_track.view.trackPlayer
import kotlinx.android.synthetic.main.view_item_album_track.view.trackTitle
...
class AlbumTrackAdapter (private val context: Context):RecyclerView.Adapter<AlbumTrackAdapter.ViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder =
        ViewHolder(LayoutInflater.from(context).inflate(R.layout.view_item_album_track,parent,false))
